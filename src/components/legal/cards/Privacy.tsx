    ...
    <div>
      <div data-custom-class="body">
            ...
            <strong>
              <span style={{ fontSize: "15px" }}>
                <span data-custom-class="subtitle">
                  Last updated <div className="question">February 01, 2023</div>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
              ...
              <span data-custom-class="body_text">
                ...
                <div className="statement-end-if-in-editor" />) your information
                when you use our services (<div className="block-component" />"
          ...
          <li style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  Visit our website
                  <div className="block-component" /> at{" "}
                  <div className="question">
                    <a
          ...
          <li style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  Download and use
                  <div className="block-component" /> our mobile application
                  <div className="block-component" /> (
                  <div className="question">
                    After Action)
                    <span
          ...
          <span style={{ fontSize: "15px" }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span data-custom-class="body_text">
                ...
                <div className="question">pierregober@gmail.com</div>.
              </span>
            </span>
          </span>
        </div>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: "15px" }}>
            <span data-custom-class="body_text">
              ...
              <div className="block-component" />
              <div className="question">After Action, Inc</div>
              <div className="statement-end-if-in-editor" /> and the Services,
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: "15px" }}>
            <span data-custom-class="body_text">
              ...
              cybercriminals, or other <div className="block-component" />
              unauthorized
              <div className="statement-end-if-in-editor" /> third parties will
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: "15px" }}>
            <span data-custom-class="body_text">
              ...
              form available <div className="block-component" />
            </span>
          </span>
          <a
            data-custom-class="link"
            href="https://app.termly.io/notify/02754ac4-0748-449d-8d4c-8b7ccbb6f68b"
          ...
          <span style={{ fontSize: "15px" }}>
            <span data-custom-class="body_text">
              <div className="block-component" />, or by contacting us. We will
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: "15px" }}>
            <span data-custom-class="body_text">
              Want to learn more about what <div className="block-component" />
              <div className="question">After Action, Inc</div>
              <div className="statement-end-if-in-editor" /> does with any
            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  <span style={{ fontSize: "15px" }}>
                    <span data-custom-class="body_text">
                      <div className="question">job titles</div>
                    </span>
                  </span>
                </span>
              </span>
          ...
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                <div className="question">Stripe</div>
                <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    <span data-custom-class="body_text">
                      <span
          ...
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                <div className="block-component" />"
                <div className="statement-end-if-in-editor" /> below.
              </span>
            </span>
          </span>
        </div>
            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <span style={{ fontSize: "15px" }}>&nbsp;</span>(such as the
                ...
                <ul>
                  <li style={{ lineHeight: "1.5" }}>
                    <span data-custom-class="body_text">
                      <span style={{ fontSize: "15px" }}>
                        <strong>
                          To <div className="block-component" />
                          fulfill
                      ...
                      <li style={{ lineHeight: "1.5" }}>
                        <span style={{ fontSize: "15px" }}>
                          <span data-custom-class="body_text">
                            ...
                            display <div className="block-component" />
                            personalized
                            <div className="statement-end-if-in-editor" />{" "}
                              ...
                              <div style={{ lineHeight: "1.5" }}>
                                ...
                                <div style={{ lineHeight: "1.5" }}>
                                    ...
                                    <em>
                                      <span style={{ fontSize: "15px" }}>
                                        <span data-custom-class="body_text">
                                          ...
                                          only process your personal information
                                    ...
                                    <li style={{ lineHeight: "1.5" }}>
                                      <span data-custom-class="body_text">
                                        <span style={{ fontSize: "15px" }}>
                                          ...
                                          personalized
                                          <div className="statement-end-if-in-editor" />{" "}
                                          and relevant advertising content for
                                          our users
                                          <div className="statement-end-if-in-editor" />
                                        </span>
                                      </span>
                                    ...
                                    <li style={{ lineHeight: "1.5" }}>
                                      <span data-custom-class="body_text">
                                        <span style={{ fontSize: "15px" }}>
                                          ...
                                          your vital interests or the vital
                                          interests of a third party, such as
                                          situations involving potential threats
                                    ...
                                    <li style={{ lineHeight: "1.5" }}>
                                      <span data-custom-class="body_text">
                                        <span style={{ fontSize: "15px" }}>
                                          ...
                                          interests of an individual and consent
                                    ...
                                    <li style={{ lineHeight: "1.5" }}>
                                      <span data-custom-class="body_text">
                                        <span style={{ fontSize: "15px" }}>
                                          ...
                                          believe an individual has been, is, or
                                    ...
                                    <li style={{ lineHeight: "1.5" }}>
                                      <span data-custom-class="body_text">
                                        <span style={{ fontSize: "15px" }}>
                                          ...
                                          collection and use with consent would
                                          ...
                                          an agreement or a contravention of the
                                    ...
                                    <li style={{ lineHeight: "1.5" }}>
                                      <span data-custom-class="body_text">
                                        <span style={{ fontSize: "15px" }}>
                                          ...
                                          with a subpoena, warrant, court order,
                                          or rules of the court relating to the
                                  ...
                                  <div style={{ lineHeight: "1.5" }}>
                                    <span style={{ fontSize: "15px" }}>
                                      <span data-custom-class="body_text">
                                        We <div className="block-component" />
                                              ...
                                              >
                                                ...
                                                >
                                                  <span data-custom-class="body_text">
                                                    ...
                                                    ability to register and log
                                                    in using your third-party
                                                    ...
                                                    The profile information we
                                                    receive may vary depending
                                                    on the social media provider
                                              ...
                                              >
                                                ...
                                                >
                                                  <span data-custom-class="body_text">
                                                    ...
                                                    EEA or UK and you believe we
                                                    are unlawfully processing
                                                    your personal information,
                                                    you also have the right to
                                                    complain to your local data
                                                    protection supervisory
                                                    authority. You can find
                                            ...
                                            <div style={{ lineHeight: "1.5" }}>
                                              ...
                                              >
                                                <span data-custom-class="body_text">
                                                  ...
                                                  deactivate or delete your
                                                  account and information from
                                                  our active databases. However,
                                                  we may retain some information
                                                  in our files to prevent fraud,
                                                  troubleshoot problems, assist
                                                  with any investigations,
                                                  enforce our legal terms and/or
                                              ...
                                              >
                                                ...
                                                >
                                                  <span data-custom-class="body_text">
                                                    ...
                                                    usually choose to set your
                                                    browser to remove cookies
                                                    and to reject cookies. If
                                                    you choose to remove cookies
                                              ...
                                              >
                                                ...
                                                >
                                                  <span data-custom-class="body_text">
                                                    ...
                                                    account with Services, you
                                                    have the right to request
                                                    removal of unwanted data
                                                    that you publicly post on
