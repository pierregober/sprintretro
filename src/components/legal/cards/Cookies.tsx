      ...
      <div data-custom-class="body">
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
              <span data-custom-class="body_text">
                ...
                <div className="question">After Action, Inc</div>) are called
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
              <span data-custom-class="body_text">
                We use first-
                <div className="block-component" /> and third-
          ...
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                in the table below (please note that the specific&nbsp;
              </span>
              <span data-custom-class="body_text">
            ...
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
              ...
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  (sometimes called "tracking pixels" or "clear gifs"). These
                  are tiny graphics files that contain a unique identifier that
                  enables us to recognize when someone has visited our Website
                  <div className="block-component" /> or opened an email
                  including them
                  <div className="statement-end-if-in-editor" />. This allows
            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              ...
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  example, changes to the cookies we use or for other
            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <div className="question">pierregober@gmail.com</div> or by
                  post to:
                </span>
              </span>
            </span>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <div className="question">
              <span data-custom-class="body_text">
                3035 SE Maricamp Rd Ste 104 B117
              </span>
            </div>
            <span data-custom-class="body_text">
              <div className="block-component" />
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span data-custom-class="body_text">
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <div className="question">Ocala</div>
              <div className="block-component" />
              <div className="block-component" />,{" "}
              <div className="question">FL</div>
              <div className="statement-end-if-in-editor" />
              <div className="block-component" />
              <div className="block-component" />{" "}
              <div className="question">34471</div>
              <div className="statement-end-if-in-editor" />
              <div className="block-component" />
              <div className="block-component" />
              <div className="block-component" />
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span data-custom-class="body_text">
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <div className="statement-end-if-in-editor">
                Phone: <div className="question">(+1)6163753723</div>
              </div>
            </span>
          </span>
          <span data-custom-class="body_text">
